...
const Contact = () => {
  ...
  return (
    <div className="flex justify-start items-center  w-full flex-wrap md:flex-nowrap lg:flex-nowrap">
      ...
      <div className="w-full lg:w-1/2 md:w-1/2">
        ...
        <ul className="list-none pt-6 w-3/4 pl-4">

          <li className="mb-3 flex items-center gap-3">
            <BiMailSend className="text-4xl text-gray-500 "/>
            <a href="mailto:k-akhtar@hotmail.com" className="underline cursor-pointer">k-akhtar@hotmail.com</a>
          </li>
          <li className="mb-3 flex items-center gap-3">
            <BiPhone className="text-4xl text-blue-500"/>
            +021 34632799
          </li>
          ...
          <li className="mb-3 flex items-center gap-3">
            <BiLogoWhatsapp className='invisible text-4xl text-red-500' />
            +92 333 8204949
          </li>
          <li className="mb-3 flex  items-center gap-3">
            <div className="text-4xl text-red-500"><BiMap /></div>
